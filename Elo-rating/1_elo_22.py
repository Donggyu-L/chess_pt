...
from Alphazero_chess.env import Chess
from Alphazero_chess.mcts_Alphazero import MCTSPlayer
from Alphazero_chess.file_utils import *
from Alphazero_chess.network import PolicyValueNet as MegaNet
from Alphazero_chess.network_copy import PolicyValueNet as AlphaZeroNet
...
if __name__ == '__main__':
    ...
    # model_file1 = "/home/hail/PreferenceTransformer/AlphaPT_chess/Eval/nmcts10/train_001.pth"
    # model_file1 = "/home/hail/PreferenceTransformer/Alphazero_chess/Eval/nmcts30/train_010.pth"

    model_file1 = "/home/hail/PreferenceTransformer/AlphaPT_chess/Eval/nmcts2/train_500.pth"
    model_file2 = "/home/hail/PreferenceTransformer/Alphazero_chess/Eval/nmcts2/train_500.pth"

    # model_file2 = "/home/hail/PreferenceTransformer/Alphazero_chess/Eval/nmcts10/train_001.pth"
    ...
    policy_value_net1 = AlphaZeroNet(8, 8, model_file=model_file1)
    mcts_player1 = MCTSPlayer(policy_value_net1.policy_value_fn, c_puct, 2, is_selfplay=0)

    policy_value_net2 = AlphaZeroNet(8, 8, model_file=model_file2)
    mcts_player2 = MCTSPlayer(policy_value_net2.policy_value_fn, c_puct, 2, is_selfplay=0)
