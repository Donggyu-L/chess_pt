...
def policy_evaluate(env, current_mcts_player, old_mcts_player, n_games=500):
    ...
    for j in range(n_games):
        ...
        if winner==1 :
            ...
            print('draw')
        win_cnt[winner] += 1
        print("{} / 500 - move_len: {} ".format(j + 1, len(move)))
        print(move)
...
if __name__ == '__main__':
    ...
    model_file1 = "/home/hail/PreferenceTransformer/AlphaPT_chess/Eval/nmcts25/train_215.pth"
    model_file2 = "/home/hail/PreferenceTransformer/Alphazero_chess/Eval/nmcts25/train_235.pth"
