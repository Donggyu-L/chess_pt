...
openings = {
    'A10': [666, 3364, 918, 3299, 1699, 4013, 334, 2915, 405],
...
def start_play(env, player1, player2):
    """Start a game between two players with predefined opening moves."""
    state = env.reset()
    players = [1, 0]
    p1, p2 = players
    player1.set_player_ind(p1)
    ...
    opening_name, opening_moves = random.choice(list(openings.items()))
...
if __name__ == '__main__':
    ...
    model_file2 = "/home/hail/PreferenceTransformer/Alphazero_chess/Eval/nmcts25/train_190.pth"
