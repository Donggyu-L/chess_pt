...
if __name__ == '__main__':
    ...
    model_file2 = "/home/hail/PreferenceTransformer/AlphaPT_chess/Eval/nmcts100/train_050.pth"
    model_file1 = "/home/hail/PreferenceTransformer/Alphazero_chess/Eval/nmcts100/train_040.pth"
    ...
    mcts_player2 = MCTSPlayer(policy_value_net2.policy_value_fn, c_puct, 100, is_selfplay=0)

    policy_value_net1 = AlphaZeroNet(8, 8, device,model_file=model_file1)
    mcts_player1 = MCTSPlayer(policy_value_net1.policy_value_fn, c_puct, 100, is_selfplay=0)
